...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: KwsMedia</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: KwsMedia</h1>
...
<header>
    <h2>
        <span class="ancestors"><a href="module-KwsMedia.html">KwsMedia</a>~</span>
...
<dt>
    <h4 class="name" id="KwsMedia"><span class="type-signature"></span>new KwsMedia<span class="signature">(uri)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="external-String.html">external:String</a></span>
            ...
            <td class="description last">Address of the Kurento Media Server</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="KwsMedia.js.html">lib/KwsMedia.js</a>, <a href="KwsMedia.js.html#line86">line 86</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="createMediaObject"><span class="type-signature">&lt;inner> </span>createMediaObject<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="KwsMedia.js.html">lib/KwsMedia.js</a>, <a href="KwsMedia.js.html#line329">line 329</a>
    </li></ul></dd>
