...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: HttpEndpoint</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: HttpEndpoint</h1>
...
<dt>
    <h4 class="name" id="HttpEndpoint"><span class="type-signature">&lt;abstract> </span>new HttpEndpoint<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="HttpEndpoint.js.html">lib/endpoints/HttpEndpoint.js</a>, <a href="HttpEndpoint.js.html#line33">line 33</a>
    </li></ul></dd>
        ...
        <ul>
            <li>module:kwsMediaApi~SessionEndpoint</li>
        </ul>
...
<dt>
    <h4 class="name" id="constructorParams"><span class="type-signature">&lt;static> </span>constructorParams<span class="type-signature"> :<a href="endpoints-HttpEndpoint.html#constructorParams">module:kwsMediaApi/endpoints~HttpEndpoint.constructorParams</a></span></h4>
...
<span class="param-type"><a href="endpoints-HttpEndpoint.html#constructorParams">module:kwsMediaApi/endpoints~HttpEndpoint.constructorParams</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="HttpEndpoint.js.html">lib/endpoints/HttpEndpoint.js</a>, <a href="HttpEndpoint.js.html#line75">line 75</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="events"><span class="type-signature">&lt;static> </span>events<span class="type-signature"> :<a href="endpoints-HttpEndpoint.html#events">module:kwsMediaApi/endpoints~HttpEndpoint.events</a></span></h4>
...
<span class="param-type"><a href="endpoints-HttpEndpoint.html#events">module:kwsMediaApi/endpoints~HttpEndpoint.events</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="HttpEndpoint.js.html">lib/endpoints/HttpEndpoint.js</a>, <a href="HttpEndpoint.js.html#line81">line 81</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="getUrl"><span class="type-signature"></span>getUrl<span class="signature">(<span class="optional">callback</span>)</span><span class="type-signature"> &rarr; {<a href="endpoints-HttpEndpoint.html">module:kwsMediaApi/endpoints~HttpEndpoint</a>}</span></h4>
...
<span class="param-type">module:kwsMediaApi/endpoints~HttpEndpoint.getUrlCallback</span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="HttpEndpoint.js.html">lib/endpoints/HttpEndpoint.js</a>, <a href="HttpEndpoint.js.html#line61">line 61</a>
    </li></ul></dd>
...
<span class="param-type"><a href="endpoints-HttpEndpoint.html">module:kwsMediaApi/endpoints~HttpEndpoint</a></span>
...
<dt>
    <h4 class="name" id="HttpEndpoint"><span class="type-signature"></span>new HttpEndpoint<span class="signature">(id)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="HttpEndpoint.js.html">lib/endpoints/HttpEndpoint.js</a>, <a href="HttpEndpoint.js.html#line46">line 46</a>
    </li></ul></dd>
