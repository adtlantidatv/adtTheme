...
<head>
    <meta charset="utf-8">
    <title>JSDoc: External: EventEmitter</title>
...
<div id="main">
    ...
    <h1 class="page-title">External: EventEmitter</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Node.js EventEmitter object.</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="KwsMedia.js.html">lib/KwsMedia.js</a>, <a href="KwsMedia.js.html#line517">line 517</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="http://nodejs.org/api/events.html#events_class_events_eventemitter">EventEmitter</a></li>
        </ul>
    </dd>
