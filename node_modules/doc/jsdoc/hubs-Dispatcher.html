...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Dispatcher</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Dispatcher</h1>
...
<header>
    <h2>
        <span class="ancestors"><a href="hubs.html">kwsMediaApi/hubs</a>~</span>
...
<dt>
    <h4 class="name" id="Dispatcher"><span class="type-signature"></span>new Dispatcher<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Dispatcher.js.html">lib/hubs/Dispatcher.js</a>, <a href="Dispatcher.js.html#line33">line 33</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="constructorParams"><span class="type-signature">&lt;static> </span>constructorParams<span class="type-signature"> :<a href="hubs-Dispatcher.html#constructorParams">module:kwsMediaApi/hubs~Dispatcher.constructorParams</a></span></h4>
...
<span class="param-type"><a href="hubs-Dispatcher.html#constructorParams">module:kwsMediaApi/hubs~Dispatcher.constructorParams</a></span>
...
<span class="param-type">MediaPipeline</span>
            ...
            <td class="description last">the :rom:cls:`MediaPipeline` to which the dispatcher belongs</td>
        </tr>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Dispatcher.js.html">lib/hubs/Dispatcher.js</a>, <a href="Dispatcher.js.html#line91">line 91</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="events"><span class="type-signature">&lt;static> </span>events<span class="type-signature"> :<a href="hubs-Dispatcher.html#events">module:kwsMediaApi/hubs~Dispatcher.events</a></span></h4>
...
<span class="param-type"><a href="hubs-Dispatcher.html#events">module:kwsMediaApi/hubs~Dispatcher.events</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Dispatcher.js.html">lib/hubs/Dispatcher.js</a>, <a href="Dispatcher.js.html#line102">line 102</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="connect"><span class="type-signature"></span>connect<span class="signature">(source, sink, <span class="optional">callback</span>)</span><span class="type-signature"> &rarr; {<a href="hubs-Dispatcher.html">module:kwsMediaApi/hubs~Dispatcher</a>}</span></h4>
...
<span class="param-type">HubPort</span>
            ...
            <td class="description last">Source port to be connected</td>
        </tr>
...
<span class="param-type">HubPort</span>
            ...
            <td class="description last">Sink port to be connected</td>
        </tr>
...
<span class="param-type">module:kwsMediaApi/hubs~Dispatcher.connectCallback</span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Dispatcher.js.html">lib/hubs/Dispatcher.js</a>, <a href="Dispatcher.js.html#line68">line 68</a>
    </li></ul></dd>
...
<span class="param-type"><a href="hubs-Dispatcher.html">module:kwsMediaApi/hubs~Dispatcher</a></span>
...
<dt>
    <h4 class="name" id="Dispatcher"><span class="type-signature"></span>new Dispatcher<span class="signature">(id)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Dispatcher.js.html">lib/hubs/Dispatcher.js</a>, <a href="Dispatcher.js.html#line47">line 47</a>
    </li></ul></dd>
